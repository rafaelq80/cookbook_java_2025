...
classDiagram
    class Usuario {
        ...
        + getAll() ResponseEntity List
        + getById(id: Long) ResponseEntity Usuario
        + postUsuario(usuario: Usuario) ResponseEntity Usuario
        + putUsuario(usuario: Usuario) ResponseEntity Usuario
        + autenticarUsuario(usuarioLogin: UsuarioLogin) ResponseEntity UsuarioLogin
    }
