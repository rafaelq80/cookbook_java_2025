...
**Linhas 28 e 29:** Foi realizada a injeção de dependência da classe **`JwtAuthFilter`**, permitindo o acesso e uso do filtro JWT dentro da configuração de segurança.
