...
> [!IMPORTANT]
>
> Por retornar **Promises**, o Axios permite trabalhar com **.then()/.catch()** ou ****, tornando o código mais limpo e legível, especialmente em requisições encadeadas ou com tratamento de erros mais complexo.
>
