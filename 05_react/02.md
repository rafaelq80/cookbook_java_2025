...
O **TypeScript** é uma linguagem de programação desenvolvida pela **Microsoft**, que funciona como um **superset do JavaScript**. Isso significa que **quase qualquer código JavaScript válido também é código TypeScript**, mas o TypeScript adiciona recursos adicionais, principalmente a **tipagem estática**.
